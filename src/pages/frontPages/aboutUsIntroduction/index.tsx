...
export const getServerSideProps = (async () => {
	const [aboutUsResponseDto, memberResponseDtos, certificateResponseDtos] = await Promise.all([
		...
		<div className="container p-5">
			...
			<div className="row g-5 justify-content-center">
				<div className="col col-md-10 col-12">
					<div className="fs-2 text-success text-center mb-4">Về chúng tôi</div>
  return (
      ...
      <div className="container p-5">
        ...
        <div className="row g-5 justify-content-center">
          ...
          <div className="col col-md-10 col-12">
			...
			<div className="row g-5 justify-content-center my-5">
				<div className="col col-md-10 col-12">
					<div className="fs-2 text-success text-center mb-4">Tại sao chọn chúng tôi</div>
        ...
        <div className="row g-5 justify-content-center my-5">
          <div className="col col-md-10 col-12">
			...
			<div className="row g-5 justify-content-center my-5">
				<div className="col col-md-10 col-12">
					<div className="fs-2 text-success text-center mb-4">Sự khác biệt của chúng tôi</div>
        ...
        <div className="row g-5 justify-content-center my-5">
          <div className="col col-md-10 col-12">
			...
			<div className="row g-5 justify-content-center my-5">
				<div className="col col-md-10 col-12">
					<div className="fs-2 text-success text-center mb-4">Văn hoá của chúng tôi</div>
        ...
        <div className="row g-5 justify-content-center my-5">
          <div className="col col-md-10 col-12">
			...
			<div className="row g-5 justify-content-center my-5">
				<div className="col col-md-10 col-12">
					<div className="fs-2 text-success text-center mb-2">Đội ngũ của chúng tôi</div>
				</div>
        {/* Members */}
        <div className="row g-5 justify-content-center my-5">
          <div className="col col-md-10 col-12">
				...
				{props.model.members.map((member) => (
					...
					>
						<img
							...
							className={`rounded-circle flex-shrink-0 mb-3 shadow ${styles.memberThumbnail}`}
							alt={member.fullName}
						/>
          {props.model.members.map(member => (
            <div
            ...
            >
              ...
              {/* FullName */}
              <span
                className={"fs-4 fw-bold bg-success-subtle border border-success-subtle " +
                          "rounded text-success px-2 text-success"}>
                {member.fullName}
              </span>
			...
			<div className="row g-5 justify-content-center my-5">
				<div className="col col-md-10 col-12">
					<div className="fs-2 text-success text-center mb-2">Chứng chỉ</div>
				</div>
        {/* Certificates */}
        <div className="row g-5 justify-content-center my-5">
          <div className="col col-md-10 col-12">
